...
public class FranquiaService {
    ...
    public List<FranquiaDTO> getAll(){ //pega todas as entidades, converte para DTO e retorna uma lista disso
    ...
    public void save(FranquiaPayloadDTO input) { //banco só entende entity, entao tem q converter pra entity e dale

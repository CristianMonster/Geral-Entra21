...
public class GeneroService {
    ...
    public List<GeneroDTO> getAll(){ //pega todas as entidades, converte para DTO e retorna uma lista disso
    ...
    public void save(GeneroPayloadDTO input) { //banco só entende entity, entao tem q converter pra entity e dale
